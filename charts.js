...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // (otuID => "OTU " + otuID) is the same as (otuID => `OTU ${otuID}`)
    ...
    var traceB = [{
      ...
      marker: {
        ...
        // Challenge doesnt say to but had to add this colorscale to match picture
        colorscale: "Earth"
      }
    }]
    ...
    Plotly.newPlot("gauge", traceG, layout);
  });
}
